...
public class GA_QBF extends AbstractGA<Integer, Integer> {
	...
	public static void main(String[] args) throws IOException {
		GA_QBF ga = new GA_QBF(1000, 100, 1.0 / 20.0, "instances/qbf20", populationReplacement.STSTATE, true, 0);
		Map<String, Object> log = ga.solve(1800.0, Integer.MAX_VALUE, Integer.MAX_VALUE);
	}
}
