 ...
 * an inverse QBFPT function is adopted.
 *
...
public class GRASP_QBF extends AbstractGRASP<Integer> {
     ...
     */
    public GRASP_QBF(Double alpha, 
    				 Integer iterations, 
    				 String filename, 
    				 Integer seed) throws IOException {
        super(new QBF_Inverse(filename), alpha, iterations, seed);
    }
	...
	public static void main(String[] args) throws IOException {
		GRASP_QBF grasp = new GRASP_QBF(0.40, 10000, "instances/qbf020", 0);
		Map<String, Object> log = grasp.solve(1800.0, Integer.MIN_VALUE, Integer.MIN_VALUE);
	}
}
